...
class SiteSettingsController extends Controller {
  ...
  public function __construct() {
    ...
    $this->route_model = new BreadRoutes('site_settings');
  ...
  public function index() {
    $data = SiteSettings::get_all_site_settings();
  ...
  public function create() {
    $fields = SiteSettings::get_all_site_settings_fields();
    $renderedViews = [];
  ...
  public function store(Request $request) {
    ...
    if ($site_settings->store_site_settings($request)) {
  ...
  public function edit($id) {
    $fields = SiteSettings::get_all_site_settings_fields();
    $renderedViews = [];
    $site_settings_values = SiteSettings::get_site_settings($id);
    foreach ($fields as $field) {
      $BreadFieldsView = new Fields(
        $field["field_name"],
        $field["data_type"],
        $field["step"],
        $field["options"],
        $site_settings_values->{$field["field_name"]}
      );
      $renderedViews[] = $BreadFieldsView->render();
    }
  ...
  public function update(Request $request, $id) {
    //TODO VALIDATION
    SiteSettings::update_site_settings($request, $id);
